...
最新執行狀態：ED-SKITARII-TW-005 已新增累計 75 個 active localization tables 的 `zh-tw`，translation repo commit 為 `7b81ca1`。下一批由 `loc_talent_cryptic_crits_grant_tdr_desc` 繼續；Skitarii 進度為 75/101。
