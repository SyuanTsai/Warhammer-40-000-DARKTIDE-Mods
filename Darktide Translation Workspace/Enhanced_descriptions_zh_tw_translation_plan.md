...
最新執行狀態：ED-PSYKER-TW-003 已完成累計 45 個 active localization tables，translation repo commit 為 `85db8ca`。下一批由 `loc_talent_psyker_toughness_on_warp_kill_desc` 繼續，Psyker 完成後處理已確認存在的 `Main_Modules/TALENTS/TALENTS_Skitarii.lua`。
