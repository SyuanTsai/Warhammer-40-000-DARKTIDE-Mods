...
| Voltaic Shock Mine | 電能地雷 | Enhanced_descriptions | `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua` | `loc_talent_ability_shock_mine` | `Referneces/Translation.md` includes the English term but has an empty zh-tw value; local table already uses this concise talent name. | candidate | Added during ED-NAMES-TW-016. |
