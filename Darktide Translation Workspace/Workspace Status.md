...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | phrs.Can_proc_mult | 2026-07-14 23:51:38 +08:00 | bbe283d | no | none | ED-COLORS-TW-016: `phrs.Can_proc_mult` | ED-COLORS-TW-015 已完成並提交 translation repo；補齊 Dump Stats 色彩 key 與 Can_appl_thr_shldsb/Can_gen_mult 短語，下一批從 Can_proc_mult 繼續。 |
