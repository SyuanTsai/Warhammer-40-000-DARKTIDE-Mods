...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | talents_text_colour.Rangd_stnc | 2026-07-14 23:40:30 +08:00 | d4c9498 | no | none | ED-COLORS-TW-013: `talents_text_colour.Rangd_stnc` | ED-COLORS-TW-012 已完成並提交 translation repo；依詞彙表校正 Smite、Duty and Honour 與 Frag/Fragmentation Grenade 用語，下一批從 Rangd_stnc 繼續。 |
