...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_stacking_rending_debuff_on_weakspot_desc | 2026-07-15 16:33:36 +08:00 | 10e4d49 | no | none | ED-WEAPONS-TW-005: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_stacking_rending_debuff_on_weakspot_desc` | ED-WEAPONS-TW-004 已完成並提交 translation repo；補齊 Limbsplitter/All or Nothing/bleed/dodge/instakill/backstab 等祝福描述缺漏資訊。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
