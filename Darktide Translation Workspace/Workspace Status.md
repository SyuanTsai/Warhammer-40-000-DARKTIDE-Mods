...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | talents_text_colour.Holy_relic | 2026-07-14 23:20:05 +08:00 | 0e045fc | no | none | ED-COLORS-TW-010: `talents_text_colour.Holy_relic` | ED-COLORS-TW-009 已完成並提交 translation repo；依詞彙表與 root localization 將 Hive Scum 校正為「巢都渣滓」，下一批從 Holy_relic 繼續。 |
