...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_melee_common_wield_increased_armored_damage_desc | 2026-07-15 16:06:34 +08:00 | 8cccd2c | no | none | ED-WEAPONS-TW-001: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_melee_common_wield_increased_armored_damage_desc` | ED-NAMES-TW-019 已完成；`NAMES_Talents_Blessings.lua` active entries 已處理至檔尾且無 Lua 變更。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
