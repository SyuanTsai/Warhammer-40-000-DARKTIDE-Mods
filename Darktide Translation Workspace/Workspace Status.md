...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | toughness_text_colour.TDR | 2026-07-14 22:59:30 +08:00 | 5662d3b | no | none | ED-COLORS-TW-006: `toughness_text_colour.TDR` | ED-COLORS-TW-005 已完成並提交 translation repo；依詞彙表與 root localization 將 Soulblaze 校正為「靈魂之火」，下一批從 TDR 繼續。 |
