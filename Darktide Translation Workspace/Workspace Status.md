...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, user-owned translation repo branch and Lua commits, workspace docs commit; no PR | Enhanced_descriptions | Enhanced Descriptions | origin/Added-Traditional-Chinese at 6e043fa | Codex/Feature/Enhanced_descriptions/Revise-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions_zh_tw_revision.md | <translation-repo>/Main_Modules/PENANCES.lua | WEAPONS complete | 2026-07-19 02:37:20 +08:00 | 4a3d53a | no | none | ED2-PENANCES-REV-001 at first loc_* table | 完成檔案 7/15；WEAPONS 197 條全部審閱，QA 通過；保留使用者 `cab8cd1` Code review，不建立 PR、不推送。 |
