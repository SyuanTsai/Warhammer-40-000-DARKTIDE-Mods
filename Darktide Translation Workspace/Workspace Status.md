...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, workspace docs commit, branch, localization commit, push, create ready PR | Skitarius | Skitarius | main | Codex/Feature/Skitarius/Add-zh-tw | Darktide Translation Workspace/Log/Skitarius.md | Skitarius_localization.lua | first key | 2026-07-13 22:14:55 +08:00 | pending | pending | pending | Skitarius/Skitarius_localization.lua:first key | 依更新後 MOD Directory Map 重新比對 ready 項目。 |
...
| Skitarius | Warhammer 40,000 DARKTIDE/mods/Skitarius/scripts/mods/Skitarius/Skitarius_localization.lua | first key | codex | in_progress | Codex/Feature/Skitarius/Add-zh-tw | Darktide Translation Workspace/Log/Skitarius.md | 2026-07-13 22:14:55 +08:00 | 2026-07-13 22:14:55 +08:00 | 完成 Skitarius 重新比對並建立或更新 ready PR | 依更新後 MOD Directory Map 重新比對 Skitarius localization |
