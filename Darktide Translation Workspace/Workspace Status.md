...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/MENUS.lua | loc_contract_view_intro_title | 2026-07-15 00:18:34 +08:00 | 302677a | no | none | ED-MENUS-TW-002: `<translation-repo>/Main_Modules/MENUS.lua:loc_contract_view_intro_title` | ED-MENUS-TW-001 已完成並提交 translation repo；前八項僅覆寫俄文未新增 zh-tw，校正 Monstrosities 為「巨獸」與 Melk intro 標點。 |
