...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Zealot.lua | loc_ability_shock_grenade_description | 2026-07-15 20:36:02 +08:00 | 4d6da00 | no | none | ED-ZEALOT-TW-001: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Zealot.lua:loc_ability_shock_grenade_description` | ED-PENANCES-TW-020 已完成並提交 translation repo；PENANCES.lua active localization tables 已處理完畢。依使用者先前要求跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua`，下一批從 Zealot 描述檔開始。 |
