...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_trait_bespoke_armor_penetration_against_staggered | 2026-07-15 09:06:52 +08:00 | b05953f | no | none | ED-NAMES-TW-001: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_trait_bespoke_armor_penetration_against_staggered` | ED-TALENTS-MOD-TW-002 已完成並提交 translation repo；TALENTS_Modular.lua 已處理至檔尾，下一批進入 NAMES_Talents_Blessings.lua。 |
