...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Veteran.lua | loc_talent_veteran_weapon_switch_new_description | 2026-07-15 21:50:18 +08:00 | ecc3550 | no | none | ED-VETERAN-TW-003: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Veteran.lua:loc_talent_veteran_weapon_switch_new_description` | ED-VETERAN-TW-002 已完成並提交 translation repo；下一批從 `loc_talent_veteran_weapon_switch_new_description` 繼續。 |
