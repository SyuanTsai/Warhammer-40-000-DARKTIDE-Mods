...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Enhanced_descriptions_localization.lua | enable_debug_mode | 2026-07-14 15:30:37 +08:00 | f542736 | no | none | ED-ROOT-LOC-008: `enable_debug_mode` | 使用 gitignored local path config 解析 `<translation-repo>`；ED-ROOT-LOC-007 已完成並提交 translation repo，下一批從 enable_debug_mode 繼續。 |
