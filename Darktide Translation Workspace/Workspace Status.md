...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_ogryn_special_ammo_fire_shots | 2026-07-15 10:55:36 +08:00 | 46736c0 | no | none | ED-NAMES-TW-015: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_ogryn_special_ammo_fire_shots` | ED-NAMES-TW-014 已完成並提交 translation repo；使用者要求後續先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
