...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, workspace docs commit, branch, localization commit, push, create ready PR | scoreboard | Scoreboard | main | Codex/Feature/scoreboard/Add-zh-tw | Darktide Translation Workspace/Log/scoreboard.md | Scoreboard_localization.lua | first key | 2026-07-13 21:31:28 +08:00 | pending | pending | pending | scoreboard/Scoreboard_localization.lua:first key | 依更新後 MOD Directory Map 重新比對 ready 項目。 |
...
| scoreboard | Warhammer 40,000 DARKTIDE/mods/scoreboard/scripts/mods/scoreboard/Scoreboard_localization.lua | first key | codex | in_progress | Codex/Feature/scoreboard/Add-zh-tw | Darktide Translation Workspace/Log/scoreboard.md | 2026-07-13 21:31:28 +08:00 | 2026-07-13 21:31:28 +08:00 | 完成 scoreboard 重新比對並建立或更新 ready PR | 依更新後 MOD Directory Map 重新比對 scoreboard localization |
