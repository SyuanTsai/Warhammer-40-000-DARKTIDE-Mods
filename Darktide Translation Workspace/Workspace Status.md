...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, workspace docs commit, branch, localization commit, push, create ready PR | dmf | Darktide Mod Framework | main | Codex/Feature/dmf/Add-zh-tw | Darktide Translation Workspace/Log/dmf.md | dmf.lua | first key | 2026-07-13 21:21:42 +08:00 | pending | pending | pending | dmf/localization/dmf.lua:first key | 依更新後 MOD Directory Map 重新比對 ready 項目。 |
...
| dmf | Warhammer 40,000 DARKTIDE/mods/dmf/localization/dmf.lua | first key | codex | in_progress | Codex/Feature/dmf/Add-zh-tw | Darktide Translation Workspace/Log/dmf.md | 2026-07-13 21:21:42 +08:00 | 2026-07-13 21:21:42 +08:00 | 完成 dmf 重新比對並建立或更新 ready PR | 依更新後 MOD Directory Map 重新比對 dmf localization |
