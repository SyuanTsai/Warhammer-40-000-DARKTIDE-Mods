...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_power_bonus_on_chained_hits_on_single_target_desc | 2026-07-15 18:07:49 +08:00 | 3669a76 | no | none | ED-WEAPONS-TW-013: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_power_bonus_on_chained_hits_on_single_target_desc` | ED-WEAPONS-TW-012 已完成並提交 translation repo；校正 Weight of Fire 到 Charmed Reload 的蓄力層數、過熱/熱能、暴擊機率、脆弱、冷卻、BUG 註記、刷新、推擊清層與暴擊裝填描述。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
