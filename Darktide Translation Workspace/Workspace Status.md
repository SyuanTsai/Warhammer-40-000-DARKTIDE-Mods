...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_cleave_boost_medium | 2026-07-15 10:05:56 +08:00 | b05953f | no | none | ED-NAMES-TW-006: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_cleave_boost_medium` | ED-NAMES-TW-005 已審核完成，Lua 無需修改；下一批進入 Talent node 名稱段。 |
