...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, workspace docs commit, branch, localization commit, push, create ready PR | Power_DI | Power DI | main | Codex/Feature/Power_DI/Add-zh-tw | Darktide Translation Workspace/Log/Power_DI.md | Power_DI_localization.lua | first key | 2026-07-13 22:03:57 +08:00 | pending | pending | pending | Power_DI/Power_DI_localization.lua:first key | 依更新後 MOD Directory Map 重新比對 ready 項目。 |
...
| Power_DI | Warhammer 40,000 DARKTIDE/mods/Power_DI/scripts/mods/Power_DI/Power_DI_localization.lua | first key | codex | in_progress | Codex/Feature/Power_DI/Add-zh-tw | Darktide Translation Workspace/Log/Power_DI.md | 2026-07-13 22:03:57 +08:00 | 2026-07-13 22:03:57 +08:00 | 完成 Power_DI 重新比對並建立或更新 ready PR | 依更新後 MOD Directory Map 重新比對 Power_DI localization |
