...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, user-owned translation repo branch and Lua commits, workspace docs commit; no PR | Enhanced_descriptions | Enhanced Descriptions | origin/Added-Traditional-Chinese at 6e043fa | Codex/Feature/Enhanced_descriptions/Revise-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions_zh_tw_revision.md | <translation-repo>/Enhanced_descriptions_localization.lua | ED2-ROOT-REV-001 complete | 2026-07-18 21:55:56 +08:00 | 29cad5b | no | none | ED2-ROOT-REV-002 at language_de | 使用者不允許 PR #37；已撤銷 PR 合併閘門，改由使用者自有第一階段 commit 建立第二階段分支。首批審閱 15 條：CHANGE=4、KEEP=11。 |
