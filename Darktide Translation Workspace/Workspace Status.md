...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_bonebreaker_grenade_super_armor_explosion | 2026-07-15 10:52:20 +08:00 | 909e109 | no | none | ED-NAMES-TW-014: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_bonebreaker_grenade_super_armor_explosion` | ED-NAMES-TW-013 已完成並提交 translation repo；使用者要求後續先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
