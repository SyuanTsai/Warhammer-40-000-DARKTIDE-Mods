...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_zealot_fanatic_rage | 2026-07-15 10:22:13 +08:00 | 4cbaa58 | no | none | ED-NAMES-TW-010: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_zealot_fanatic_rage` | ED-NAMES-TW-009 已完成並提交 translation repo；使用者要求後續先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
