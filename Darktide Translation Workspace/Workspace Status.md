...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_crit_chance_on_successful_dodge_desc | 2026-07-15 17:50:11 +08:00 | 4d45ba2 | no | none | ED-WEAPONS-TW-011: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_crit_chance_on_successful_dodge_desc` | ED-WEAPONS-TW-010 已完成並提交 translation repo；校正 Execution 到 Concentrated Fire 的踉蹌、韌性、暴擊發射、反噬、弱點命中、脆弱、燃燒、彈藥消耗與近戰排除描述。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
