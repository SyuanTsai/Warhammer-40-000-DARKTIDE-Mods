...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_adamant_damage_vs_staggered_aura | 2026-07-15 15:03:08 +08:00 | 7aafc5c | no | none | ED-NAMES-TW-017: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_adamant_damage_vs_staggered_aura` | ED-NAMES-TW-016 已完成並提交 translation repo；新增 `Voltaic Shock Mine` 候選詞。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
