...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | completed | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/merge delta from 6a1e6d9 | 12 updated non-PSYKER/non-SKITARII items | 2026-07-18 12:53:19 +08:00 | d99ede0 | no | none | Main_Modules/TALENTS/TALENTS_Psyker.lua:loc_ability_psyker_smite_description_new | ED-MERGE-6A1E6D9-TW-001 已完成；只處理 merge 後已更新內容，排除 TALENTS_Psyker.lua 與 TALENTS_Skitarii.lua。正常流程下一批仍從 PSYKER 開始，Skitarii 後續依 class talent workflow 處理。 |
