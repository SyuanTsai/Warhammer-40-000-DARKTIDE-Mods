...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, user-owned translation repo branch and Lua commits, workspace docs commit; no PR | Enhanced_descriptions | Enhanced Descriptions | origin/Added-Traditional-Chinese at 6e043fa | Codex/Feature/Enhanced_descriptions/Revise-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions_zh_tw_revision.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | NAMES complete | 2026-07-19 02:12:29 +08:00 | 68d0416 | no | none | ED2-WEAPONS-REV-001 at first loc_* table | 完成檔案 6/15；已完整重讀 1,322 行最新版 Translation.md，保留使用者 `cab8cd1` Code review；不建立 PR。 |
