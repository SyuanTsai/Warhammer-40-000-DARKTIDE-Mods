...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/PENANCES.lua | loc_achievement_veteran_2_kills_with_last_round_in_mag_name | 2026-07-15 18:40:55 +08:00 | 816bef4 | no | none | ED-PENANCES-TW-004: `<translation-repo>/Main_Modules/PENANCES.lua:loc_achievement_veteran_2_kills_with_last_round_in_mag_name` | ED-PENANCES-TW-003 已完成並提交 translation repo；下一批從 `loc_achievement_veteran_2_kills_with_last_round_in_mag_name` 繼續。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
