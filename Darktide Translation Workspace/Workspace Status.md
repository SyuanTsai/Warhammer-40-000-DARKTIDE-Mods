...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | electrocuted_text_colour.Electrocute | 2026-07-14 22:46:24 +08:00 | d06694c | no | none | ED-COLORS-TW-004: `electrocuted_text_colour.Electrocute` | ED-COLORS-TW-003 已完成並提交 translation repo；依詞彙表校正本批 Critical Strike/Attack/Shots 結果與機率用語，下一批從 Electrocute 繼續。 |
