...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Enhanced_descriptions_localization.lua | bleed_colour | 2026-07-14 16:25:44 +08:00 | 2ec5615 | no | none | ED-ROOT-LOC-009: `bleed_colour` | 使用 gitignored local path config 解析 `<translation-repo>`；ED-ROOT-LOC-008 已完成並提交 translation repo，下一批從 bleed_colour 繼續。 |
