...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/MENUS.lua | loc_stats_display_mobility_stat | 2026-07-15 08:34:22 +08:00 | 2bebbdd | no | none | ED-MENUS-TW-005: `<translation-repo>/Main_Modules/MENUS.lua:loc_stats_display_mobility_stat` | ED-MENUS-TW-004 已完成並提交 translation repo；校正收藏、Perk、Primary/Secondary Action 與 Special Melee Attack 標籤。 |
