...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, workspace docs commit, branch, localization commit, push, create ready PR | creature_spawner | Creature Spawner | main | Codex/Feature/creature_spawner/Add-zh-tw | Darktide Translation Workspace/Log/creature_spawner.md | creature_spawner_localization.lua | first key | 2026-07-13 21:36:57 +08:00 | pending | pending | pending | creature_spawner/creature_spawner_localization.lua:first key | 依更新後 MOD Directory Map 重新比對 ready 項目。 |
...
| creature_spawner | Warhammer 40,000 DARKTIDE/mods/creature_spawner/scripts/mods/creature_spawner/creature_spawner_localization.lua | first key | codex | in_progress | Codex/Feature/creature_spawner/Add-zh-tw | Darktide Translation Workspace/Log/creature_spawner.md | 2026-07-13 21:36:57 +08:00 | 2026-07-13 21:36:57 +08:00 | 完成 creature_spawner 重新比對並建立或更新 ready PR | 依更新後 MOD Directory Map 重新比對 creature_spawner localization |
