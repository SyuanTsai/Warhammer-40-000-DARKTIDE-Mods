...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Arbites.lua | loc_talent_adamant_ranged_damage_on_melee_stagger_desc | 2026-07-16 09:16:10 +08:00 | 0caef9f | no | none | ED-ARBITES-TW-006: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Arbites.lua:loc_talent_adamant_ranged_damage_on_melee_stagger_desc` | ED-ARBITES-TW-005 已完成並提交 translation repo；下一批為 Arbites 最後 8 個 active table，從 `loc_talent_adamant_ranged_damage_on_melee_stagger_desc` 繼續。 |
