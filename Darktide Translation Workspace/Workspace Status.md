...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_armor_rend_on_activated_attacks_desc | 2026-07-15 16:47:11 +08:00 | cd9525c | no | none | ED-WEAPONS-TW-007: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_armor_rend_on_activated_attacks_desc` | ED-WEAPONS-TW-006 已完成並提交 translation repo；補齊 Exorcist 到 Take a Swing 的反噬、精英/專家、電擊、熱能、攻速、韌性與遠程限制資訊。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
