...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/PENANCES.lua | loc_achievement_missions_broker_2_x_description | 2026-07-15 20:00:38 +08:00 | 4e57535 | no | none | ED-PENANCES-TW-018: `<translation-repo>/Main_Modules/PENANCES.lua:loc_achievement_missions_broker_2_x_description` | ED-PENANCES-TW-017 已完成並提交 translation repo；下一批從 `loc_achievement_missions_broker_2_x_description` 繼續。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
