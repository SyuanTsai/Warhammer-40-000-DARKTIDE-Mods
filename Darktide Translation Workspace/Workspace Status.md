...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua | loc_talent_broker_blitz_flash_grenade_desc | 2026-07-16 10:35:52 +08:00 | 00a136e | no | none | ED-SCUM-TW-001: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua:loc_talent_broker_blitz_flash_grenade_desc` | ED-ARBITES-TW-006 已完成並提交 translation repo；Arbites active table 序列完成。下一批從 Scum `loc_talent_broker_blitz_flash_grenade_desc` 繼續。 |
