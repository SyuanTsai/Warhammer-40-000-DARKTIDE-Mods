...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_trait_bespoke_ignore_stagger_reduction_with_primary_on_burning | 2026-07-15 09:36:18 +08:00 | b05953f | no | none | ED-NAMES-TW-005: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_trait_bespoke_ignore_stagger_reduction_with_primary_on_burning` | ED-NAMES-TW-004 已審核完成，Lua 無需修改；下一批從第 61 個 active localization table 繼續。 |
