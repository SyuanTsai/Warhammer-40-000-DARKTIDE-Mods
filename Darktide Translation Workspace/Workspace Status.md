...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Enhanced_descriptions_localization.lua | enable_menus_file | 2026-07-14 14:26:28 +08:00 | 7c354b4 | no | none | ED-ROOT-LOC-006: `enable_menus_file` | 使用 gitignored local path config 解析 `<translation-repo>`；ED-ROOT-LOC-005 已完成並提交 translation repo，下一批從 enable_menus_file 繼續。 |
