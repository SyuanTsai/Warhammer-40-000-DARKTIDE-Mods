...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | crit_text_colour.Crt_hit_col | 2026-07-14 22:34:35 +08:00 | 0a97e7b | no | none | ED-COLORS-TW-003: `crit_text_colour.Crt_hit_col` | ED-COLORS-TW-002 已完成並提交 translation repo；依詞彙表校正本批 Crit 結果與機率用語，下一批從 Crt_hit_col 繼續。 |
