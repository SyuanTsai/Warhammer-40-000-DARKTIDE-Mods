...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | peril_text_colour.PerilsozWarp | 2026-07-14 22:51:54 +08:00 | 64d4048 | no | none | ED-COLORS-TW-005: `peril_text_colour.PerilsozWarp` | ED-COLORS-TW-004 已完成並提交 translation repo；依詞彙表與 root localization 將 Health/Max Health 校正為「生命值 / 最大生命值」，下一批從 PerilsozWarp 繼續。 |
