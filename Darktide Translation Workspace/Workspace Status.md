...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | talents_text_colour.seerspres | 2026-07-14 23:37:03 +08:00 | 709de9a | no | none | ED-COLORS-TW-012: `talents_text_colour.seerspres` | ED-COLORS-TW-011 已完成並提交 translation repo；依詞彙表校正 Assail、Brain Burst、Brain Rupture、Enfeeble 與 Scrier's Gaze 用語，下一批從 seerspres 繼續。 |
