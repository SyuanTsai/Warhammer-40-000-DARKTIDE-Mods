...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_increased_weakspot_damage_against_toxin_status_desc | 2026-07-15 17:00:18 +08:00 | 693bceb | no | none | ED-WEAPONS-TW-008: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_increased_weakspot_damage_against_toxin_status_desc` | ED-WEAPONS-TW-007 已完成並提交 translation repo；校正 Supercharge 到 Can Opener 的充能命中、韌性恢復、特殊動作、Hit Mass/順劈目標、護甲衝擊波與次要模式描述。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
