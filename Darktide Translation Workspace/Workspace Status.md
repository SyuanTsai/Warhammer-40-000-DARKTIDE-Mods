...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_psyker_restore_toughness_to_allies_when_ally_down | 2026-07-15 10:17:41 +08:00 | 955c084 | no | none | ED-NAMES-TW-009: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_psyker_restore_toughness_to_allies_when_ally_down` | ED-NAMES-TW-008 已完成並提交 translation repo；使用者要求後續先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
