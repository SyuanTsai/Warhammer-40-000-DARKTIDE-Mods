...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Psyker.lua | ED-PSYKER-TW-002 complete through `loc_talent_psyker_souls_new_desc` | 2026-07-18 13:11:00 +08:00 | a885b5c | no | none | Main_Modules/TALENTS/TALENTS_Psyker.lua:loc_talent_psyker_reduced_warp_charge_cost_venting_speed_desc | 30 Psyker active localization tables reviewed; placeholder validation passed. Skitarii remains queued after Psyker. |
