...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_damage_vs_stagger_desc | 2026-07-15 17:16:34 +08:00 | 6c5c79d | no | none | ED-WEAPONS-TW-010: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_damage_vs_stagger_desc` | ED-WEAPONS-TW-009 已完成並提交 translation repo；校正 Surgical 到 Point Blank 的瞄準層數、弱點命中、踉蹌、壓制免疫、持續射擊、後座力、腰射、流血、爆炸與近戰擊殺遠程暴擊描述。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
