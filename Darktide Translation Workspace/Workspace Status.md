...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| copilot | in_progress | granted | git checkout/fetch/branch/status/diff, commit, push, create ready PR | creature_spawner | Creature Spawner | main | Codex/Feature/creature_spawner/Add-zh-tw | Darktide Translation Workspace/Log/creature_spawner.md | creature_spawner_localization.lua | all keys | 2026-07-07 +08:00 | - | - | - | 處理中 | 修正詞彙表不一致（Combat Ability） |
