...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, user-owned translation repo branch and Lua commits, workspace docs commit; no PR | Enhanced_descriptions | Enhanced Descriptions | origin/Added-Traditional-Chinese at 6e043fa | Codex/Feature/Enhanced_descriptions/Revise-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions_zh_tw_revision.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | ED2-ROOT-REV-001..007 complete | 2026-07-18 22:35:59 +08:00 | b6c968e | no | none | ED2-COLORS-REV-001 at first assignment | 根 localization 93 條已完成：CHANGE=19、KEEP=74；不建立 PR。 |
