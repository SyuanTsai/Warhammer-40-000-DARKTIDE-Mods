...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Ogryn.lua | loc_talent_ogryn_carapace_armor_trigger_on_zero_stacks_new_desc | 2026-07-15 23:45:28 +08:00 | 565713c | no | none | ED-OGRYN-TW-003: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Ogryn.lua:loc_talent_ogryn_carapace_armor_trigger_on_zero_stacks_new_desc` | ED-OGRYN-TW-002 已完成並提交 translation repo；下一批從 `loc_talent_ogryn_carapace_armor_trigger_on_zero_stacks_new_desc` 繼續。 |
