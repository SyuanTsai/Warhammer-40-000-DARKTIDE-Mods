...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Veteran.lua | loc_ability_frag_grenade_description | 2026-07-15 21:32:49 +08:00 | ee8bf39 | no | none | ED-VETERAN-TW-001: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Veteran.lua:loc_ability_frag_grenade_description` | ED-ZEALOT-TW-006 已完成並提交 translation repo；Zealot active localization tables completed. 下一批從 Veteran `loc_ability_frag_grenade_description` 繼續。 |
