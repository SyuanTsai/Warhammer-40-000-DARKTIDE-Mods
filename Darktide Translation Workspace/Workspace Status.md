...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | paused | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_ogryn_melee_stagger | 2026-07-15 11:35:28 +08:00 | 39dae4b | no | none | ED-NAMES-TW-016: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_ogryn_melee_stagger` | ED-NAMES-TW-015 已完成並提交 translation repo；依使用者要求本批次完成後停止。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
