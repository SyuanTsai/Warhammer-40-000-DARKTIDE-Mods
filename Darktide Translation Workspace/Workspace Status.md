...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/CURIOS_Blessings_Perks.lua | loc_trait_gadget_mission_reward_gear_instead_of_weapon_increase_desc | 2026-07-15 08:43:29 +08:00 | ba792c4 | no | none | ED-CURIOS-TW-002: `<translation-repo>/Main_Modules/CURIOS_Blessings_Perks.lua:loc_trait_gadget_mission_reward_gear_instead_of_weapon_increase_desc` | ED-CURIOS-TW-001 已完成並提交 translation repo；校正最大生命值、戰鬥技能恢復、腐敗抗性、格擋消耗降低、韌性與審判庭代幣等珍品屬性。 |
