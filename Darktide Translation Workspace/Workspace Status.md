...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua | loc_talent_broker_passive_reload_speed_on_close_kill_desc | 2026-07-16 11:04:21 +08:00 | 0db5bb4 | no | none | ED-SCUM-TW-004: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua:loc_talent_broker_passive_reload_speed_on_close_kill_desc` | ED-SCUM-TW-003 已完成並提交 translation repo；下一批從 Scum `loc_talent_broker_passive_reload_speed_on_close_kill_desc` 繼續。 |
