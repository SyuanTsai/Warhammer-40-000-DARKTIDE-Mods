...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | class_psyker_text_colour.cls_psys | 2026-07-14 23:07:12 +08:00 | e88c68e | no | none | ED-COLORS-TW-007: `class_psyker_text_colour.cls_psys` | ED-COLORS-TW-006 已完成並提交 translation repo；依詞彙表與 root localization 校正 Toughness Damage Reduction 與 Weak Spot/Weakspot Hit 用語，下一批從 cls_psys 繼續。 |
