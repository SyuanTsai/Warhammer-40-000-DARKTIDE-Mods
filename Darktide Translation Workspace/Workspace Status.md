...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Arbites.lua | loc_talent_ability_adamant_grenade_description | 2026-07-16 00:34:39 +08:00 | ca6a011 | no | none | ED-ARBITES-TW-001: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Arbites.lua:loc_talent_ability_adamant_grenade_description` | ED-OGRYN-TW-006 已完成並提交 translation repo；Ogryn active table 序列完成。下一批從 Arbites `loc_talent_ability_adamant_grenade_description` 繼續。 |
