...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua | loc_talent_broker_passive_extended_mag_desc | 2026-07-16 11:07:27 +08:00 | 3bc3ec0 | no | none | ED-SCUM-TW-005: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua:loc_talent_broker_passive_extended_mag_desc` | ED-SCUM-TW-004 已完成並提交 translation repo；下一批從 Scum `loc_talent_broker_passive_extended_mag_desc` 繼續。 |
