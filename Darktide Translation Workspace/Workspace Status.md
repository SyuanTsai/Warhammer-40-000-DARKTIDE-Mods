...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | bleed_text_colour.Bleed | 2026-07-14 22:22:49 +08:00 | f097ddc | no | none | ED-COLORS-TW-001: `bleed_text_colour.Bleed` | 使用 gitignored local path config 解析 `<translation-repo>`；ED-ROOT-LOC-013 已完成，root localization 檔已處理完畢且本批無 Lua 變更，下一批從 COLORS_KWords_tw.lua 第一個詞彙繼續。 |
