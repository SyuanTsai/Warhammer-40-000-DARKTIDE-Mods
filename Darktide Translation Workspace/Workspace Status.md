...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Ogryn.lua | loc_talent_ogryn_windup_reduces_damage_taken_desc | 2026-07-16 00:30:24 +08:00 | cd56ec5 | no | none | ED-OGRYN-TW-006: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Ogryn.lua:loc_talent_ogryn_windup_reduces_damage_taken_desc` | ED-OGRYN-TW-005 已完成並提交 translation repo；下一批為 Ogryn 最後 13 個 active table，從 `loc_talent_ogryn_windup_reduces_damage_taken_desc` 繼續。 |
