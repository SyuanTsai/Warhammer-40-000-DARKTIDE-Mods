...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_adamant_melee_weakspot_hits_count_as_stagger | 2026-07-15 15:59:40 +08:00 | 8cccd2c | no | none | ED-NAMES-TW-019: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_adamant_melee_weakspot_hits_count_as_stagger` | ED-NAMES-TW-018 已完成並提交 translation repo；依更新後詞彙表校正 `Shield Plates`。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
