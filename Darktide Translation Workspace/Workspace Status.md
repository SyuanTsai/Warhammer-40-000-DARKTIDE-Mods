...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Psyker.lua | ED-PSYKER-TW-001 complete through `loc_talent_psyker_shout_ability_description` | 2026-07-18 13:03:14 +08:00 | bf72179 | no | none | Main_Modules/TALENTS/TALENTS_Psyker.lua:loc_talent_psyker_shout_vent_warp_charge_description | Psyker quality pass resumed; first 15 active localization tables reviewed and corrected. Skitarii remains queued after Psyker. |
