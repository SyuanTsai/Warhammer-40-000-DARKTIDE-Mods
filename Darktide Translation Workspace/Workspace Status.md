...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_bleed_on_activated_hit_desc | 2026-07-15 16:17:52 +08:00 | cb6b25e | no | none | ED-WEAPONS-TW-003: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_bleed_on_activated_hit_desc` | ED-WEAPONS-TW-002 已完成並提交 translation repo；校正 ranged perk 屬性與 Opportunist 描述、移除 zh-tw `vs` 殘留。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
