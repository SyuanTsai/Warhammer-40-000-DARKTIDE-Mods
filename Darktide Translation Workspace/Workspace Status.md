...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Arbites.lua | loc_talent_adamant_terminus_warrant_new_desc | 2026-07-16 00:56:50 +08:00 | f0a8bc6 | no | none | ED-ARBITES-TW-003: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Arbites.lua:loc_talent_adamant_terminus_warrant_new_desc` | ED-ARBITES-TW-002 已完成並提交 translation repo；下一批從 `loc_talent_adamant_terminus_warrant_new_desc` 繼續。 |
