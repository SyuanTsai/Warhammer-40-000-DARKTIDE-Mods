...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_crit_chance_based_on_aim_time_desc | 2026-07-15 17:09:13 +08:00 | b7eff31 | no | none | ED-WEAPONS-TW-009: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_crit_chance_based_on_aim_time_desc` | ED-WEAPONS-TW-008 已完成並提交 translation repo；校正 Refined Lethality 到 Ghost 的化學毒素、背後射擊、近距離擊殺、遠程免疫、裝填速度、壓制、持續射擊與弱點命中描述。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
