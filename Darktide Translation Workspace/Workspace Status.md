...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_reduced_damage_after_dodge | 2026-07-15 10:28:20 +08:00 | 63e3706 | no | none | ED-NAMES-TW-011: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_reduced_damage_after_dodge` | ED-NAMES-TW-010 已完成並提交 translation repo；使用者要求後續先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
