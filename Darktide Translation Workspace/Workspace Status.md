...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_veteran_snipers_focus_rending_bonus | 2026-07-15 10:31:34 +08:00 | 63e3706 | no | none | ED-NAMES-TW-012: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_veteran_snipers_focus_rending_bonus` | ED-NAMES-TW-011 已完成；無 Lua 變更。使用者要求後續先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
