...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, user-owned translation repo branch and Lua commits, workspace docs commit; no PR | Enhanced_descriptions | Enhanced Descriptions | origin/Added-Traditional-Chinese at 6e043fa | Codex/Feature/Enhanced_descriptions/Revise-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions_zh_tw_revision.md | <translation-repo>/Main_Modules/MENUS.lua | ROOT and COLORS complete | 2026-07-18 22:47:33 +08:00 | 6a24fb4 | no | none | ED2-MENUS-REV-001 at first loc_* table | 完成檔案 2/15；ROOT 93 條、COLORS 327 assignments 已完成；不建立 PR。 |
