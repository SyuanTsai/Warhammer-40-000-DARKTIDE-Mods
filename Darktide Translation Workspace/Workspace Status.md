...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_faster_charge_on_chained_attacks_desc | 2026-07-15 17:58:59 +08:00 | b6bcec9 | no | none | ED-WEAPONS-TW-012: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_faster_charge_on_chained_attacks_desc` | ED-WEAPONS-TW-011 已完成並提交 translation repo；校正 Desperado 到 Hot-Shot 的刷新、韌性互動、流血、順劈、踉蹌、雙管齊發、脆弱、燃料罐、燃燒抗性與保留層數描述。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
