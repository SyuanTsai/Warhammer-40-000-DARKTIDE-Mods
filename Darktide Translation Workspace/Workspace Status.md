...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_power_bonus_on_first_attack_desc | 2026-07-15 16:24:25 +08:00 | b9398ae | no | none | ED-WEAPONS-TW-004: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_power_bonus_on_first_attack_desc` | ED-WEAPONS-TW-003 已完成並提交 translation repo；補回 Bloodletter/Power/Cleave/Hit Mass 描述缺漏資訊。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
