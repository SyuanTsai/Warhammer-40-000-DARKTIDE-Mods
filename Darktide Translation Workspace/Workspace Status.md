...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Ogryn.lua | loc_talent_ogryn_bigger_coherency_radius_desc | 2026-07-15 23:54:09 +08:00 | d1e7c5b | no | none | ED-OGRYN-TW-004: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Ogryn.lua:loc_talent_ogryn_bigger_coherency_radius_desc` | ED-OGRYN-TW-003 已完成並提交 translation repo；下一批從 `loc_talent_ogryn_bigger_coherency_radius_desc` 繼續。 |
