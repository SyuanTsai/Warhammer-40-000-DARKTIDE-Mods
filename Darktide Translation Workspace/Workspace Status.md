...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/MENUS.lua | loc_wait_reason_store | 2026-07-15 08:37:10 +08:00 | b64a0d8 | no | none | ED-MENUS-TW-006: `<translation-repo>/Main_Modules/MENUS.lua:loc_wait_reason_store` | ED-MENUS-TW-005 已完成並提交 translation repo；補齊 Dump Stats CKWord 繁中，校正 Cloud Radius、Dedicated Server 與 Fatshark backend 等等待提示。 |
