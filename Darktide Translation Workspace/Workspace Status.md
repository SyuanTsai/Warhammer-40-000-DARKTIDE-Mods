...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua | loc_talent_broker_passive_toxin_infected_enemies_take_increased_damage_desc | 2026-07-16 13:05:01 +08:00 | 5f8a7d6 | no | none | ED-SCUM-TW-006: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua:loc_talent_broker_passive_toxin_infected_enemies_take_increased_damage_desc` | ED-SCUM-TW-005 已完成並提交 translation repo；下一批從 Scum `loc_talent_broker_passive_toxin_infected_enemies_take_increased_damage_desc` 繼續。 |
