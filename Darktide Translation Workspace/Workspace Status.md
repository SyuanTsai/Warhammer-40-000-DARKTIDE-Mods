...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Psyker.lua | ED-PSYKER-TW-004 complete through `loc_talent_psyker_cleave_from_peril_desc` | 2026-07-18 13:21:00 +08:00 | 6787469 | no | none | Main_Modules/TALENTS/TALENTS_Psyker.lua:loc_talent_psyker_melee_weaving_desc | 60 Psyker active localization tables reviewed; Skitarii remains queued after Psyker. |
