...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua | loc_talent_stat_reload_speed | 2026-07-16 13:08:31 +08:00 | fc1a8b1 | no | none | ED-SCUM-TW-007: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Scum.lua:loc_talent_stat_reload_speed` | ED-SCUM-TW-006 已完成並提交 translation repo；下一批從 Scum `loc_talent_stat_reload_speed` 繼續，預期為 Scum 最後一批 active localization tables。 |
