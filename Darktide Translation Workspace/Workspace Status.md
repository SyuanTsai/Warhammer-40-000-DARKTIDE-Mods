...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Arbites.lua | loc_talent_adamant_close_kills_restore_toughness_desc | 2026-07-16 09:08:02 +08:00 | 0808848 | no | none | ED-ARBITES-TW-004: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Arbites.lua:loc_talent_adamant_close_kills_restore_toughness_desc` | ED-ARBITES-TW-003 已完成並提交 translation repo；下一批從 `loc_talent_adamant_close_kills_restore_toughness_desc` 繼續。 |
