...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Psyker.lua | ED-PSYKER-TW-003 complete through `loc_talent_psyker_mark_weakspot_stacks_description` | 2026-07-18 13:16:00 +08:00 | 85db8ca | no | none | Main_Modules/TALENTS/TALENTS_Psyker.lua:loc_talent_psyker_toughness_on_warp_kill_desc | 45 Psyker active localization tables reviewed; Skitarii remains queued after Psyker. |
