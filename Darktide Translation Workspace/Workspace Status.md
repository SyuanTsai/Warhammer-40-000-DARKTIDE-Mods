...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua | loc_trait_bespoke_chained_weakspot_hits_vents_warpcharge_desc | 2026-07-15 16:41:01 +08:00 | 9029232 | no | none | ED-WEAPONS-TW-006: `<translation-repo>/Main_Modules/WEAPONS_Blessings_Perks.lua:loc_trait_bespoke_chained_weakspot_hits_vents_warpcharge_desc` | ED-WEAPONS-TW-005 已完成並提交 translation repo；補齊 Uncanny Strike 到 Warp Slice 的刷新、層數、反噬、靈魂之火、順劈目標與護甲限制資訊。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
