...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/MENUS.lua | loc_inventory_title_slot_gear_lowerbody | 2026-07-15 08:31:42 +08:00 | e66dab3 | no | none | ED-MENUS-TW-004: `<translation-repo>/Main_Modules/MENUS.lua:loc_inventory_title_slot_gear_lowerbody` | ED-MENUS-TW-003 已完成並提交 translation repo；補上 Stimm Lab 繁中，校正 Strike Team、Previous Missions、Havoc Assignment、Loadout 等 UI 標籤。 |
