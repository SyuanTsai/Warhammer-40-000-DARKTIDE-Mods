...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua | loc_talent_adamant_bullet_rain_toughness | 2026-07-15 15:55:23 +08:00 | 736aa2d | no | none | ED-NAMES-TW-018: `<translation-repo>/Main_Modules/NAMES_Talents_Blessings.lua:loc_talent_adamant_bullet_rain_toughness` | ED-NAMES-TW-017 已完成並提交 translation repo；`Voltaic Shock Mine` 已由更新後詞彙表解決，新增 `Dispense Justice` 候選詞。後續仍先跳過 `Main_Modules/TALENTS/TALENTS_Psyker.lua` 描述檔。 |
