...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | heresy_text_colour.heresy | 2026-07-14 23:47:47 +08:00 | e562ccd | no | none | ED-COLORS-TW-015: `heresy_text_colour.heresy` | ED-COLORS-TW-014 已完成並提交 translation repo；依詞彙表校正 Stay Close! 用語，sedition 仍為註解未啟用，下一批從 heresy 繼續。 |
