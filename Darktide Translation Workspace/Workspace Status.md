...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | talents_text_colour.assail | 2026-07-14 23:23:59 +08:00 | b7245c5 | no | none | ED-COLORS-TW-011: `talents_text_colour.assail` | ED-COLORS-TW-010 已完成並提交 translation repo；依詞彙表校正 Stun Grenade 與 Assail 用語，下一批從 assail 繼續。 |
