...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Enhanced_descriptions_localization.lua | enable_penances_file_description | 2026-07-14 14:44:53 +08:00 | cab0cf3 | no | none | ED-ROOT-LOC-007: `enable_penances_file_description` | 使用 gitignored local path config 解析 `<translation-repo>`；ED-ROOT-LOC-006 已完成並提交 translation repo，下一批從 enable_penances_file_description 繼續。 |
