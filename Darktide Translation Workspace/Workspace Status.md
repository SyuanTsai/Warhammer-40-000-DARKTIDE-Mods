...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Ogryn.lua | loc_ability_ogryn_grenade_box_description | 2026-07-15 22:39:04 +08:00 | 49c23a4 | no | none | ED-OGRYN-TW-001: `<translation-repo>/Main_Modules/TALENTS/TALENTS_Ogryn.lua:loc_ability_ogryn_grenade_box_description` | ED-VETERAN-TW-005 已完成並提交 translation repo；Veteran active localization tables completed. 下一批從 Ogryn `loc_ability_ogryn_grenade_box_description` 繼續。 |
