...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Colors_Keywords_Numbers/COLORS_KWords_tw.lua | phrs.Carap_cant_clv | 2026-07-14 23:54:24 +08:00 | 46b515e | no | none | ED-COLORS-TW-017: `phrs.Carap_cant_clv` | ED-COLORS-TW-016 已完成並提交 translation repo；補齊 Ogryn/Hive Scum 不疊加短語與 Cant_be_refr，下一批從 Carap_cant_clv 繼續。 |
