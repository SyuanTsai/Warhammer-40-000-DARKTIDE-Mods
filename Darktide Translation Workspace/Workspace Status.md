...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/TALENTS/TALENTS_Psyker.lua | ED-PSYKER-TW-005 complete through `loc_talent_psyker_warp_attacks_rending_alt_desc` | 2026-07-18 13:26:00 +08:00 | 100cc6d | no | none | Main_Modules/TALENTS/TALENTS_Psyker.lua:loc_talent_psyker_alternative_peril_explosion_new_desc | 75 Psyker active localization tables reviewed; final Psyker batch next. |
