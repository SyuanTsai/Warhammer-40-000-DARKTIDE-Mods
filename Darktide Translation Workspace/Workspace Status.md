...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codex | in_progress | granted | read/status/diff, external translation repo lua commit, workspace docs commit | Enhanced_descriptions | Enhanced Descriptions | main | Codex/Feature/Enhanced_descriptions/Add-zh-tw | Darktide Translation Workspace/Log/Enhanced_descriptions.md | <translation-repo>/Main_Modules/MENUS.lua | loc_credits_goods_vendor_description_text | 2026-07-15 08:28:56 +08:00 | a818308 | no | none | ED-MENUS-TW-003: `<translation-repo>/Main_Modules/MENUS.lua:loc_credits_goods_vendor_description_text` | ED-MENUS-TW-002 已完成並提交 translation repo；校正 Melk 標題、合約獎勵、Low/Medium/High、珍品、聖化/威力提示與徵用標籤。 |
