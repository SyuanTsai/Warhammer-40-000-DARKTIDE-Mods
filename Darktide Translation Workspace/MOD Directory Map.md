...
| in_progress | 2026-07-18 22:47:33 +08:00 | Enhanced Descriptions | Enhanced_descriptions | 使用者不允許 PR；ROOT 93 條與 COLORS 327 assignments 已完成，下一批從 `MENUS.lua` 第一個 `loc_*` table 開始。 |
