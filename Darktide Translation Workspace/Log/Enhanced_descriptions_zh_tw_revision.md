...
## TALENTS_Arbites Manual Review

| Batch | Units | CHANGE | KEEP | Translation commit | Safe next position |
| --- | ---: | ---: | ---: | --- | --- |
| ED2-ARBITES-REV-001 | 1–15 | 8 | 7 | f5dbd86 | unit 16 |
| ED2-ARBITES-REV-002 | 16–30 | 4 | 11 | f5dbd86, 7a1d485 | unit 31 |
| ED2-ARBITES-REV-003 | 31–45 | 3 | 12 | a4d7b42 | unit 46 |
| ED2-ARBITES-REV-004 | 46–60 | 5 | 10 | a09185c | unit 61 |
| ED2-ARBITES-REV-005 | 61–75 | 4 | 11 | ca69a38 | unit 76 |
| ED2-ARBITES-REV-006 | 76–83 | 2 | 6 | 1b4bee9 | SCUM first loc_* table |
| **Total** | **83** | **26** | **57** |  |  |

Reason summary: `TERMINOLOGY` (meters → `公尺`, Crit chance → `爆擊率`, Toughness Damage Reduction → `韌性傷害減免`, Weakspot Hits → `命中弱點`, and Heavy Melee Attack → `重型近戰攻擊`), `SEMANTIC_ACCURACY` (Bash blocking window, Blitz maximum charges, Forceful triggers, and non-human-sized enemy stacks), `UNNATURAL` (rounding-up wording), and `PUNCTUATION` (damage range, fullwidth dash, and sign spacing). Common checks: table count=83; missing=0; duplicate=0; empty=0; key sequence matches authorized base; residual scans for `米`, obsolete Crit/Toughness/Weakspot variants, Mainland rounding wording, and obsolete Heavy Melee/Bash wording returned 0; `git diff --check` passed; `ADD/SKIP/BLOCKED`=0; Lua syntax tool unavailable. The unit 17 Bash wording fix was staged with `f5dbd86`, so that commit is attributed to both affected review batches.

## TALENTS_Scum Manual Review

| Batch | Units | CHANGE | KEEP | Translation commit | Safe next position |
| --- | ---: | ---: | ---: | --- | --- |
| ED2-SCUM-REV-001 | 1–15 | 10 | 5 | 9b507aa | unit 16 |
| ED2-SCUM-REV-002 | 16–30 | 8 | 7 | 9b507aa, 0b05adb | unit 31 |
| ED2-SCUM-REV-003 | 31–45 | 5 | 10 | 0b05adb, 55bb04d | unit 46 |
| ED2-SCUM-REV-004 | 46–60 | 3 | 12 | a65c6ae | unit 61 |
| ED2-SCUM-REV-005 | 61–75 | 3 | 12 | a19bc24 | unit 76 |
| ED2-SCUM-REV-006 | 76–90 | 2 | 13 | 1075db5, 29265c4 | unit 91 |
| ED2-SCUM-REV-007 | 91–99 | 2 | 7 | 29265c4 | SKITARII first loc_* table |
| **Total** | **99** | **33** | **66** |  |  |
