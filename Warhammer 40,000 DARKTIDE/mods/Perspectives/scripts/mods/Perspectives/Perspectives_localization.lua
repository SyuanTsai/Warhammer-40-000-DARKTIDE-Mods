...
local loc = {
	...
	autoswitch_slot_luggable_description = {
		...
		["zh-tw"] = Localize("loc_pickup_luggable_battery_01") .. " / " .. Localize("loc_pickup_luggable_control_rod_01"),
	},
	...
	autoswitch_act2_primary = {
		...
		["zh-tw"] = Localize("loc_ingame_action_two") .. " - " .. Localize("loc_inventory_title_slot_primary"),
	},
	autoswitch_act2_secondary = {
		en = Localize("loc_ingame_action_two") .. " - " .. Localize("loc_inventory_title_slot_secondary"),
		["zh-tw"] = Localize("loc_ingame_action_two") .. " - " .. Localize("loc_inventory_title_slot_secondary"),
	},
	autoswitch_to_none = {
		en = "Don't Switch",
		["zh-cn"] = "不切换",
	...
	autoswitch_slab_block = {
		...
		["zh-tw"] = Localize("loc_weapon_special_defensive_stance")
			.. " - " .. Localize("loc_weapon_family_ogryn_powermaul_slabshield_p1_m1"),
	},
	show_hub_hands = {
...
if crosshair_remap and crosshair_remap.all_crosshair_names then
	...
	for _, type in ipairs(mod._xhair_types) do
		loc["xhair_" .. type] = {
			...
			["zh-tw"] = crosshair_remap:localize(type .. "_crosshair"),
		}
	end
else
