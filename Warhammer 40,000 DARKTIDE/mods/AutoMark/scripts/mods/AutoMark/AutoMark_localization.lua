...
local localization = {
    ...
    companion_mark_tagged_always_visible_description = {
        ...
        ["zh-tw"] = "開啟後，被任意標記或處刑命令選中的目標，電子獒犬自動標記將始終視其為可見。",
    },
    threat_priority = {
        en = "Threat Priority",
        ["zh-cn"] = "威胁优先",
    ...
    threat_priority_tooltip = {
        ...
        ["zh-tw"] = "開啟後，支援單位自動標記將優先標記以玩家為攻擊目標的敵人。",
    },
    ...
    companion_range_limitation_tooltip = {
        ...
        ["zh-cn"] = "限制伙伴自动标记系统可标记的目标与你的" .. highlight("伙伴") .. "之间的最大距离。\n\n" ..
            "设置为" .. highlight("0") .. "以禁用。",
        ["zh-tw"] = "限制支援單位自動標記系統可標記的目標與你的" .. highlight("支援單位") .. "之間的最大距離。\n\n" ..
            "設為" .. highlight("0") .. "可停用",
    },
    ...
    companion_mark_max_distance_tooltip = {
        ...
        ["zh-cn"] = "限制伙伴自动标记系统可标记的目标与" .. highlight("玩家") .. "之间的最大距离。\n\n" ..
            "设置为" .. highlight("0") .. "以禁用。",
        ["zh-tw"] = "限制支援單位自動標記系統可標記的目標與" .. highlight("玩家") .. "之間的最大距離。\n\n" ..
            "設為" .. highlight("0") .. "可停用",
    },
    -- cryptic settings
    cryptic_settings = {
    ...
    servo_skull_mark_keybind_description = {
        ...
        ["zh-tw"] = "伺服顱骨標記專用按鍵。身為護教軍，你現在可同時使用一般敵人標記與伺服顱骨標記。\n\n" ..
            "當" .. highlight("支援單位目標標記") .. "設為" .. highlight("按一次") .. "時，此功能會變為一般敵人標記。",
    },
