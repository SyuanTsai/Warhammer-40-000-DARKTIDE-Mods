...
local localization = {
    ...
    companion_mark_tagged_always_visible_description = {
        ...
        ["zh-tw"] = "啟用後，任何已標記或被處刑命令選中的目標，都會被電子獒犬自動標記視為可見。",
    },
    threat_priority = {
        en = "Threat Priority",
        ["zh-cn"] = "威胁优先",
    ...
    execution_order_priority_description = {
        ...
        ["zh-tw"] = "法務官電子獒犬自動標記會優先標記處刑命令選中的敵人。",
    },
    ...
    execution_order_force_mark_description = {
        ...
        ["zh-tw"] = "啟用後，即使處刑命令選中目標的敵人類型在優先度設定中被設為忽略，仍可自動標記該目標。",
    },
    ...
    sticky_targeting_tooltip = {
        ...
        ["zh-tw"] = "為所選敵人類型啟用標記黏滯。如果被標記的敵人啟用了標記黏滯，自動標記會暫停由優先順序切換造成的目標切換。",
    },
    ...
    servo_skull_health_threshold_tooltip = {
        ...
        ["zh-cn"] = "当你的伺服颅骨的攻击目标的血量低于所选百分比时，取消该目标的伺服颅骨标记。\n\n" ..
            "设置为" .. highlight("0") .. "以禁用。\n" ..
            "对" .. highlight("手动") .. "标记无效。",
        ["zh-tw"] = "當你的伺服頭骨目前攻擊目標的生命值低於設定百分比時，取消該目標的伺服頭骨標記。\n\n" ..
            "設為" .. highlight("0") .. "可停用。\n" ..
            "不影響" .. highlight("手動") .. "標記。",
    },
}
