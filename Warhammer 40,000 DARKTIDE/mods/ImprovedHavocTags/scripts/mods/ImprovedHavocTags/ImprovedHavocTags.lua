...
mod:add_global_localize_strings({
	...
	loc_havoc_enemies_parasite_headshot_name = {
        en = "{#color(" .. get_color_string(mod:get("enemies_parasite_headshot")) .. ")}Cranial Corruption{#reset()}",
        ru = "{#color(" .. get_color_string(mod:get("enemies_parasite_headshot")) .. ")}Внутричерепная инфекция{#reset()}",
        ["zh-cn"] = "{#color(" .. get_color_string(mod:get("enemies_parasite_headshot")) .. ")}颅部腐坏{#reset()}",
		["zh-tw"] = "{#color(" .. get_color_string(mod:get("enemies_parasite_headshot")) .. ")}顱骨腐敗{#reset()}",
    },
	loc_havoc_tougher_skin_name = {
        en = "{#color(" .. get_color_string(mod:get("tougher_skin")) .. ")}Pus-hardened Skin{#reset()}",
