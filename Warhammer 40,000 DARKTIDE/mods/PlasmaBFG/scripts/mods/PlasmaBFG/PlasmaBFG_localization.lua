return {
	...
	mod_description = {
		...
		["zh-tw"] = "僅限電漿槍的改版，預設數值接近原版並啟用功能切換，所有設定仍可手動調整。",
	},
	group_primary_fire = {
		en = "Handling",
		["zh-tw"] = "操控",
	...
	group_primary_fire_description = {
		...
		["zh-tw"] = "預設接近原版操控，並啟用長壓主射輔助。較低的時間和乘數使武器更快速且更易控制。",
	},
	group_ammo = {
		en = "Ammo",
		["zh-tw"] = "彈藥",
	...
	group_ammo_description = {
		...
		["zh-tw"] = "預設接近原版彈藥消耗，並啟用空彈匣自動填裝。較低的消耗或較大的彈藥池使武器更寬容。",
	},
	group_heat = {
		en = "Heat & Safety",
		["zh-tw"] = "熱能與安全",
	...
	group_heat_description = {
		...
		["zh-tw"] = "預設熱能數值接近原版並啟用安全切換。散熱速度和傷害仍可手動調整。",
	},
	group_damage = {
	...
	group_damage_description = {
		...
		["zh-tw"] = "預設啟用衝擊和爆炸切換，而貫穿和範圍保持接近原版。",
	},
	...
	hipfire_release_factor_description = {
		...
		["zh-tw"] = "腰射自動釋放前等待的蓄能量。較低值發射更快但威力較弱。原版接近值：1.00。超負荷值：1.00。",
	},
	...
	primary_shot_total_time_description = {
		...
		["zh-tw"] = "主射動作的總時間。較低值速度更快。原版接近值：0.50。超負荷值：0.40。",
	},
	...
	primary_rechain_time_description = {
		...
		["zh-tw"] = "主射後能再次蓄能的時間。較低值速度更快。原版接近值：0.45。超負荷值：0.35。",
	},
	...
	primary_sprint_ready_up_time_description = {
		...
		["zh-tw"] = "主射後恢復衝刺操控的延遲時間。較低值手感更靈敏。原版接近值：0.60。超負荷值：0.45。",
	},
	...
	primary_charge_sprint_ready_up_time_description = {
		...
		["zh-tw"] = "開始主射蓄能後恢復衝刺操控的延遲時間。較低值手感更靈敏。原版接近值：0.40。超負荷值：0.30。",
	},
	...
	held_primary_assist_enabled_description = {
		...
		["zh-tw"] = "長壓主射鍵時保持主射循環運作，包含自動散熱後。預設：開啟。",
	},
	recoil_multiplier = {
		en = "Recoil",
		["zh-tw"] = "後座力",
	...
	recoil_multiplier_description = {
		...
		["zh-tw"] = "縮放原版電漿槍後座力。較低值後座力越小。原版接近值：1.00。超負荷值：0.25。",
	},
	spread_multiplier = {
		en = "Spread",
		["zh-tw"] = "散佈",
	...
	spread_multiplier_description = {
		...
		["zh-tw"] = "縮放原版電漿槍散佈。較低值射擊更精準。原版接近值：1.00。超負荷值：0.25。",
	},
	primary_ammo_cost = {
		en = "Primary Cost",
		["zh-tw"] = "主射彈藥消耗",
	...
	charged_ammo_max_description = {
		...
		["zh-tw"] = "蓄能射擊可消耗的最大彈藥量。原版接近值：8。超負荷值：4。",
	},
	...
	ammo_pool_multiplier_description = {
		...
		["zh-tw"] = "同時倍增裝填發數和備用彈藥池。原版接近值：1.00。超負荷值：2.00。",
	},
	...
	auto_reload_empty_enabled_description = {
		...
		["zh-tw"] = "當電漿槍彈匣為空且有備用彈藥時自動填裝。預設：開啟。此功能優先於自動散熱。",
	},
	auto_vent_enabled = {
		en = "Auto-Vent",
		["zh-tw"] = "自動散熱",
	...
	auto_vent_enabled_description = {
		...
		["zh-tw"] = "在電漿槍達到危險點之前自動散熱。預設：開啟。原版：關閉。",
	},
	...
	auto_vent_start_percent_description = {
		...
		["zh-tw"] = "強制散熱開始的熱能百分比。較低值更安全，較高值更激進。原版接近值：99。超負荷值：98。",
	},
	...
	disable_overheat_explosion_description = {
		...
		["zh-tw"] = "將致命過熱重導為散熱而非爆炸。預設：開啟。原版：關閉。",
	},
	...
	vent_damage_multiplier_description = {
		...
		["zh-tw"] = "縮放散熱時的自傷和韌性損失。原版接近值：1.00。超負荷值：0.00。",
	},
	...
	vent_speed_multiplier_description = {
		...
		["zh-tw"] = "縮放散熱持續時間和最短散熱持押時間。較低值速度更快。原版接近值：1.00。超負荷值：0.50。",
	},
	...
	primary_charge_duration_basic_description = {
		...
		["zh-tw"] = "屬性縮放前的基本主射蓄能時間。較低值速度更快。原版接近值：1.00。超負荷值：0.80。",
	},
	...
	primary_charge_duration_perfect_description = {
		...
		["zh-tw"] = "其他增益前的最佳擲骰主射蓄能時間。較低值速度更快。原版接近值：0.50。超負荷值：0.40。",
	},
	...
	primary_charge_overheat_basic_description = {
		...
		["zh-tw"] = "基本主射蓄能期間增加的熱量。較低值更安全。原版接近值：0.090。超負荷值：0.070。",
	},
	...
	primary_charge_overheat_perfect_description = {
		...
		["zh-tw"] = "完美擲骰主射蓄能期間增加的熱量。較低值更安全。原版接近值：0.045。超負荷值：0.035。",
	},
	...
	primary_charge_full_overheat_description = {
		...
		["zh-tw"] = "主射完全蓄能時額外施加的熱量。較低值更安全。原版接近值：0.025。超負荷值：0.020。",
	},
	...
	primary_shot_overheat_basic_description = {
		...
		["zh-tw"] = "基本主射增加的熱量。較低值更安全。原版接近值：0.300。超負荷值：0.240。",
	},
	...
	primary_shot_overheat_perfect_description = {
		...
		["zh-tw"] = "完美擲骰主射增加的熱量。較低值更安全。原版接近值：0.150。超負荷值：0.120。",
	},
	primary_bfg_impact = {
		en = "BFG Impact",
		["zh-tw"] = "BFG 衝擊",
	...
	primary_bfg_impact_description = {
		...
		["zh-tw"] = "將蓄能 BFG 衝擊傷害配置複製到主射上。預設：開啟。原版：關閉。",
	},
	...
	primary_demolition_explosion_description = {
		...
		["zh-tw"] = "在主射衝擊和穿出命中上加上爆破爆炸。預設：開啟。原版：關閉。",
	},
	...
	primary_penetration_depth_description = {
		...
		["zh-tw"] = "主射能持續貫穿的距離。較高值穿透力更強。原版接近值：1.25。超負荷值：2.00。",
	},
	...
	charged_penetration_depth_description = {
		...
		["zh-tw"] = "蓄能射擊能持續貫穿的距離。較高值穿透力更強。原版接近值：2.00。超負荷值：3.00。",
	},
	...
	penetration_target_count_description = {
		...
		["zh-tw"] = "射擊可連續貫穿的敵人數量。較高值穿透力更強。原版接近值：2。超負荷值：4。",
	},
	...
	charged_explosion_radius_multiplier_description = {
		...
		["zh-tw"] = "縮放電漿爆破和穿出爆炸範圍。原版接近值：1.00。超負荷值：1.35。",
	},
}
