	return {
        ...
        not_with_stimm_supply_description = {
            ...
            ["zh-tw"] = "如果你擁有「興奮劑補給」戰鬥技能，停用自動注射興奮劑。",
        },
