local mod = get_mod("chest_markers")
        ...
        widgets = {
            {
                setting_id = "general_settings", type = "group", sub_widgets = {
                    ...
                    {setting_id = "min_size", type = "numeric", default_value = 0.2, range = {0.2, 0.4}, decimals_number = 2},
					{setting_id = "max_size", type = "numeric", default_value = 0.4, range = {0.4, 1}, decimals_number = 2},
