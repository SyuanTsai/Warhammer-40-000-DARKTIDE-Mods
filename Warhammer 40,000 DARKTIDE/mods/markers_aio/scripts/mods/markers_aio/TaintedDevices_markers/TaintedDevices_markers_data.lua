local mod = get_mod("TaintedDevices_markers")
        ...
        widgets = {
            {
                ...
                setting_id = "tainted_colour", type = "group", sub_widgets = {
                    {setting_id = "tainted_colour_R", type = "numeric", default_value = 205, range = {0, 255}},
                    {setting_id = "tainted_colour_G", type = "numeric", default_value = 255, range = {0, 255}},
