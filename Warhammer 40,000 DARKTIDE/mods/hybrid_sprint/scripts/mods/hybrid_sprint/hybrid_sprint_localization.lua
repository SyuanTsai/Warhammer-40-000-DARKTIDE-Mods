...
return {
	...
	mod_description = {
		...
		["zh-tw"] = "透過結合「切換衝刺」與「長按衝刺」機制，提供更佳的衝刺體驗。鬆開前進鍵並按下武器操作即可取消衝刺。",
	},
	...
	start_sprint_buffer_description = {
		...
		["zh-tw"] = "按下衝刺鍵後，在按下前進鍵之前允許衝刺的持續時間（以秒為單位）。"
	},
	enable_hold_to_sprint_description = {
		...
		["zh-tw"] = "只有在長按按鍵時才會衝刺，基本上等同於停用此模組。",
	},
	...
	enable_keep_sprint_after_weapon_action_description = {
		...
		["zh-tw"] = "只要你仍然按住前進鍵，武器操作結束後即可繼續衝刺。",
	},
	debug_group = {
		en = "Debug",
		ru = "Отладка",
