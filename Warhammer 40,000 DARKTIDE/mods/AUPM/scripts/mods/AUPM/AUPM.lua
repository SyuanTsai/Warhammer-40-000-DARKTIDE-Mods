	...
	instance.widget_definitions.aupm_text = UIWidget.create_definition({
		{
			...
			style = {
				...
				text_horizontal_alignment = "left",
				text_color = Color.white(255, true),
				offset = { 250 + mod:get("team_x_offset"), -24 + mod:get("team_y_offset"), 0 },
			},
			visibility_function = function (content, style)
				style.offset = { 250 + mod:get("team_x_offset"), -24 + mod:get("team_y_offset"), 0 }
				return true
			end
		},
		{
			...
			style = {
				...
				text_horizontal_alignment = "left",
				text_color = Color.white(255, true),
				offset = { 250 + mod:get("team_x_offset"), 0 + mod:get("team_y_offset"), 0 },
			},
			visibility_function = function (content, style)
				style.offset = { 250 + mod:get("team_x_offset"), 0 + mod:get("team_y_offset"), 0 }
				return true
			end
		},
	}, "toughness_bar")
