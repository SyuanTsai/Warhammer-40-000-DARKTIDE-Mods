...
--Rows exploration_tier_0
	...
	{name = "total_expeditions_currency_pickups",
		text = "row_total_expeditions_currency_pickups",
		validation = "ASC",
		iteration = "ADD",
		group = "group_1",
		setting = "exploration_tier_0",
	...
	{name = "total_expeditions_loot_pickups",
		text = "row_total_expeditions_loot_pickups",
		validation = "ASC",
		iteration = "ADD",
		group = "group_1",
		setting = "exploration_tier_0",
