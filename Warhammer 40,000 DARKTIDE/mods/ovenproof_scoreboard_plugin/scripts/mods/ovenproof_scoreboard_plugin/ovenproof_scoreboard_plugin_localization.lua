...
local localization = {
    ...
    error_scoreboard_missing = {
        ...
        ["pt-br"] = "Scoreboard necessário! Este é um plugin complementar!",
    },
    ...
    attack_tracking_group = {
        ...
        ["zh-cn"] = "攻击报告追踪",
        ["zh-tw"] = "攻擊報告追蹤",
        ["pt-br"] = "Acompanhamento de relatório de ataque",
    },
    exploration_tier_0 = {
        en = "Exploration",
        ru = "Исследование",
    ...
    track_ammo_crate_waste = {
        ...
        ["zh-cn"] = "轨道弹药箱废物",
        ["zh-tw"] = "追蹤彈藥箱浪費",
        ["pt-br"] = "Rastrear resíduos de caixas de munição",
    },
    track_ammo_crate_waste = {
        en = "Track Ammo Crate Waste",
		ru = "Отходы ящиков с боеприпасами для треков",
    ...
    explosions_affect_melee_hitrate = {
        ...
        ["zh-cn"] = "爆炸影响近战命中率",
        ["zh-tw"] = "爆炸影響近戰命中率",
        ["pt-br"] = "Explosões afetam a taxa de acerto corpo a corpo",
    },
    -- ----------------
    -- Reusable labels
    -- ----------------
    ...
    message_ammo_waste = {
        ...
        ru = " подобрал %s, потратил %s патронов",
        ["zh-cn"] = "拾取了%s，浪费了%s弹药",
    ...
    message_ammo_crate = {
        ...
        ru = " подобрал %s боеприпасов из %s",
        ["zh-cn"] = "拾取了%s弹药，来自%s",
        ["zh-tw"] = "拾取了 %s 彈藥，來自 %s",
    ...
    message_ammo_crate_waste = {
        ...
        ru = " подобрал %s боеприпасов у %s, тратя %s впустую",
        ["zh-cn"] = "从 %s 处拾取了 %s 弹药，浪费了 %s",
        ["zh-tw"] = "拾取了 %s 彈藥，來自 %s，浪費了 %s",
        ["pt-br"] = " coletou %s munição de um %s, desperdiçando %s",
    },
    ...
    row_ammo_1 = {
		...
		ru = {left = "Всего боеприпасов", right = "[ Взятый | Потраченный ]",},
