...
--Rows defense_tier_0
	...
	row_total_friendly = {
		...
		["zh-tw"] = {left = "總友方", right = "[ 傷害 | 阻擋射擊次數 ]"},
	},
	row_friendly_damage = {
		en = "Damage",
		ru = "Урона",
