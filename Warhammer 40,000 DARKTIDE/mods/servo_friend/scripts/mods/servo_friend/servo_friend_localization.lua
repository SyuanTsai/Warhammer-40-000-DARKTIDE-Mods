return {
	...
	mod_option_victory_speech_frequency_tooltip = {
		...
		["zh-tw"] = "調節機械靈樞播報凱旋聖言的間隔週期（單位：作戰分鐘）",
	},
	mod_option_voice = {
		en = "Voice",
		de = "Stimme",
	...
	mod_option_avoid_daemonhost_tooltip = {
		...
		["zh-tw"] = "啟用靈能遮蔽場，避免伺服器顱骨助手的光學傳感器驚醒惡魔宿主",
	},
	...
	mod_option_keep_packages_tooltip = {
		...
		["zh-tw"] = "在重新載入模組時，保持伺服器顱骨和附加模組的包裹處於載入狀態",
	},
	group_aiming = {
		en = "Aiming",
		de = "Zielen",
