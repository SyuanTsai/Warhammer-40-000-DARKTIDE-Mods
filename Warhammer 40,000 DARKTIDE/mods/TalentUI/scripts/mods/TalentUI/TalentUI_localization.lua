return {
	...
	mod_description = {
		...
		["zh-tw"] = "在隊伍 HUD 中顯示隊友與自身的技能圖示與冷卻計時器。顯示隊友武器圖示與彈藥數量。支援多種位置預設，並可自訂圖示、冷卻與文字顯示設定。\n\n更改設定後，請重新載入模組：Ctrl+Shift+R",
	},
	...
	teammate_ability_position_preset_tooltip = {
		...
		["zh-tw"] = "選擇技能圖示的位置預設。每個預設會套用預先定義的偏移數值與設定。",
	},
	...
	teammate_weapon_position_preset_tooltip = {
		...
		["zh-tw"] = "選擇武器圖示的位置預設。每個預設會套用預先定義的偏移數值與設定。",
	},
